...
ind <- c("Money Center Banks",  "Money Center Banks",  "Money Center Banks", "Money Center Banks",  "Electrical Utilities", "Electrical Utilities", "Electrical Utilities", "Electrical Utilities", "Electrical Utilities", "Biotechnology",  "Biotechnology", "Biotechnology", "Biotechnology", "Machinery",  "Machinery", "Fuel Refining", "Fuel Refining", "Fuel Refining", "Index")
...
means <- colMeans(as.data.frame(gr1$R[,-19]))
